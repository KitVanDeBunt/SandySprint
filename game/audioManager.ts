...
class audioManager {
    ...
    constructor(scene: BABYLON.Scene) {
        ...
        this._jumpSound = this.addSound("Jumpsound", "../assets/sounds/jump.wav", false, 0.15, 1);
        ...
        this._stopSound = this.addSound("StopSound", "../assets/sounds/stop.mp3", false, 0.7, 1);
        this._spikeSound = this.addSound("SpikeSound", "../assets/sounds/Sword.mp3", false, 0.7, 1);
        this._laneSwitchSound = this.addSound("SwitchSound", "../assets/sounds/swipe.wav", false, 0.1, 1);
        this._walkSoundL = this.addSound("WalkSoundL", "../assets/sounds/Walk1.mp3", false, 0.05, 0.8);
        this._walkSoundR = this.addSound("WalkSoundR", "../assets/sounds/Walk2.mp3", false, 0.05, 0.8);
    }
